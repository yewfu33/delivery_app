    ...
    return Scaffold(
      ...
      body: ConstrainedBox(
        ...
        child: SingleChildScrollView(
          child: Container(
            padding:
                const EdgeInsets.only(top: 24, left: 15, right: 15, bottom: 35),
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${setWeightInfo(newOrder.weight.toInt())}, ${setVehicleType(newOrder.vehicleType)}',
                  ...
                  itemBuilder: (_, i) {
                    return Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top: 10, left: 10),
                          child: Text('+60${newOrder.dropPoint[i].contact}',
                              style: const TextStyle(fontSize: 15.5)),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 10, left: 10),
          ...
          if (isLoading)
            ...
            RaisedButton(
              onPressed: () async {
                ...
                final bool v = await widget.callBack(widget.order);
                if (v) {
